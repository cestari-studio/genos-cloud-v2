                    ...
                    <Column lg={8} md={8} sm={4}>
                        <Tile className="compliance-audit-card">
                            <Stack gap={5}>
                                ...
                                <div>
                                    <h6 className="cds--type-label-01" style={{ color: 'var(--cds-text-helper)', marginBottom: '0.5rem' }}>{t('complianceVisualDiff')}</h6>
                        ...
                        <Stack gap={5} style={{ height: '100%' }}>
                            <Tile className="compliance-audit-card">
                                <Stack gap={4}>
                                    ...
                                    <div>
                                        <p className="cds--type-label-01" style={{ color: 'var(--cds-text-secondary)' }}>{t('complianceCharProgress')}</p>
                                        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginTop: '0.25rem' }}>
                                            <h3 className="cds--type-productive-heading-04" style={{ color: isRejected ? 'var(--cds-support-error)' : 'var(--cds-support-success)' }}>
                                                {metrics.char_count || 0}
                                            </h3>
                                            <span style={{ color: 'var(--cds-text-helper)' }}>/ {metrics.char_limit || 280} {t('complianceMaxAllowed')}</span>
                                        </div>
                                    </div>

                                    <div>
                                        <p className="cds--type-label-01" style={{ color: 'var(--cds-text-secondary)' }}>{t('complianceHashtagCount')}</p>
                                        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginTop: '0.25rem' }}>
                                            <h3 className="cds--type-productive-heading-04" style={{ color: isRejected ? 'var(--cds-support-error)' : 'var(--cds-support-success)' }}>
