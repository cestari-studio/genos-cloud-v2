        ...
        <Stack gap={7}>
            ...
            <Grid narrow>
                    ...
                    <Tile>
                        <Stack gap={4}>
                            ...
                            <Stack orientation="horizontal" gap={2}>
                                <span className="cds--type-label-01">API</span>
                                <AILabel autoAlign>
                                    <AILabelContent>
                                        <p>Publicação via Container do Meta Graph API. O genOS cria o container de mídia e publica em dois estágios, respeitando rate limits do Instagram.</p>
                                    </AILabelContent>
                                </AILabel>
                            </Stack>
                    ...
                    <Tile>
                        <Stack gap={4}>
                            ...
                            <Stack orientation="horizontal" gap={2}>
                                ...
                                <AILabel autoAlign>
                                    <AILabelContent>
                                        <p>Publicação direta via Graph API na página conectada. Token de longa duração (60 dias) com renovação automática pelo genOS.</p>
                                    </AILabelContent>
                                </AILabel>
                            </Stack>
                ...
                <Column lg={3} md={4} sm={4}>
                    <Tile className="social-card--coming-soon">
                        <Stack gap={4}>
                            <Stack orientation="horizontal" gap={3}>
                                <Stack orientation="horizontal" gap={4}>
